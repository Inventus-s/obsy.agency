...
// Function to be executed when the screen matches the criteria
function runScript() {
  // Your script code here
  console.log('Script executed on specific screen size.');
...
// Check if the initial screen size matches the media query
if (mediaQuery.matches) {
  runScript(); // Execute the script immediately if the condition is met initially
}

// Add a listener to run the script when the screen size matches the criteria
...
function page2Animation(){
    ...
    videoContainer.addEventListener('mouseleave',()=>{
      ...
      document.querySelector('.video-adjust').innerHTML = `<div class="video-crsr">
